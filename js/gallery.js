...
// отримуємо доступ до елемента списку
...
//створення тегу картинки
const linkImg = document.createElement('img')
linkImg.classList.add('gallery-image')
linkImg.src = `${preview}`// потрібно замінити на маленьку картинку в масиві об'єктів
linkImg.dataset.source = `${original}`// вставити значення з масиву об'єктів
linkImg.alt = `${description}`//вставити значення з масиву об'єктів
